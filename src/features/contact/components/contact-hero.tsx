        ...
        <div className="container relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sc-red font-medium">Get in Touch</span>
              <div className="h-1 w-12 bg-sc-red rounded-full" />
            </motion.div>

            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
              We're Here to{" "}
              <span className="text-sc-red">Support Your Journey</span>
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Have questions about our German language courses? Want to learn
              more about our programs? We're here to help you take the first
              step towards mastering German.
            </p>
          </motion.div>
        </div>
      </section>
